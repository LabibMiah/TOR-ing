...
export default async function DashboardPage() {
  ...
  if (recentBookings && recentBookings.length > 0) {
    // Get all booking items for recent bookings
    ...
    // Get the last booking's first item to determine category for recommendations
  ...
  // Get recommendations based on last category
